...
while valid is False:
	...
	if "a" in choice:
		off_course_name = "computer+science"
		valid = True
	elif "b" in choice:
		off_course_name = "accounting+and+finance"
		valid = True
	elif "c" in choice:
		off_course_name = "english"
		valid = True
	elif "d" in choice:
		off_course_name = "electrical+and+electronic+engineering"
		valid = True
	elif "h" in choice:
		for uni in unis:
			print(uni.name.replace("-", " ").title())
	else:
		valid = False
		print("\nNot a valid input! Grrrr, do it again!")
